...
system('python -m nuitka --standalone --onefile --output-filename="Johannesburg Flytipping Report.exe" --windows-icon-from-ico="images/logo_v2.ico" --enable-plugin=tk-inter main.py')